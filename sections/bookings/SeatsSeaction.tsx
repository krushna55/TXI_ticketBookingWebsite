        ...
        const channel = supabase
            ...
            .on('postgres_changes', {
                ...
                if (payload.eventType === 'INSERT') {
                    ...
                    // ✅ handle status change hold -> paid via webhook
                    setAllBookings(prev =>
                            ...
                            return (
                                <button
                                    ...
                                    className={`
                                        ...
                                        ${colIndex + 1 === middleGap ? 'mr-24' : ''}
                                        ${isPaidByMe
                                            ? 'bg-royal text-white cursor-not-allowed'      // ✅ green — you paid
                                            : isPaidByOthers
                                                ? 'bg-royal text-white cursor-not-allowed'            // ✅ royal — others paid
                                                : isHeldByOthers
                                                    ? 'bg-gray-300 text-gray-500 cursor-not-allowed'       // ✅ yellow — others holding
                                                    : isSelectedByMe
                                                        ? 'bg-choosenBtnColor text-white shadow-lg scale-110' // ✅ chosen — your hold
                                                        : 'border-2 border-gray-400 hover:border-royal hover:text-royal' // ✅ available
                                        }
                                    `}
                                >
                                    {colIndex + 1}
