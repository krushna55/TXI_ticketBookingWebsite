...
// export default function MobileNavbar({ user, setUser, updateScroll }: { user: any, setUser: (v: any) => void, updateScroll: (value: boolean) => void }) {
...
//                     <Link href="/tickets" onClick={closeMenu}>My Tickets</Link>
//                     <Link href="/blog" onClick={closeMenu}>TXI News</Link>
//                     </div>
